...
public class starOut {
	...
	public String starOut(String str) {
		...
		for(int i = 0; i < str.length(); i++) {
			if(i == 0 && str.charAt(i) != '*')
				builder.append(str.charAt(i) + ""); //Append if first char is not a *
			
			if(i > 0 && str.charAt(i) != '*' && str.charAt(i-1) != '*') //Append if not a *
				builder.append(str.charAt(i) + "");
			
			if(i > 0 && str.charAt(i) == '*' && str.charAt(i-1) != '*') //Delete right of *
